...
const APP_GRID_DATA_VERSION = 12
...
const builtinPlatformApps: Omit<Apps, 'id' | 'order'>[] = [
  ...
  { name: '微博', icon: platformIcon('weibo.svg'), url: 'https://weibo.com', syncStatus: 'synced' },
  { name: '哔哩哔哩', icon: platformIcon('bilibili.svg'), url: 'https://www.bilibili.com', syncStatus: 'synced' },
  { name: '知乎', icon: platformIcon('zhihu.svg'), url: 'https://www.zhihu.com', syncStatus: 'synced' },
  { name: '淘宝', icon: platformIcon('taobao.svg'), url: 'https://www.taobao.com', syncStatus: 'synced' },
  { name: '京东', icon: platformIcon('jd.png'), url: 'https://www.jd.com', syncStatus: 'synced' },
  { name: '豆瓣', icon: platformIcon('douban.svg'), url: 'https://www.douban.com', syncStatus: 'synced' },
  { name: '百度', icon: platformIcon('baidu.svg'), url: 'https://www.baidu.com', syncStatus: 'synced' },
  { name: '百度网盘', icon: platformIcon('baidu-pan.svg'), url: 'https://pan.baidu.com', syncStatus: 'synced' },
  { name: '腾讯视频', icon: platformIcon('tencent-video.png'), url: 'https://v.qq.com', syncStatus: 'synced' },
  { name: '爱奇艺', icon: platformIcon('iqiyi.png'), url: 'https://www.iqiyi.com', syncStatus: 'synced' },
  { name: '优酷', icon: platformIcon('youku.png'), url: 'https://www.youku.com', syncStatus: 'synced' },
  { name: '抖音', icon: platformIcon('douyin.svg'), url: 'https://www.douyin.com', syncStatus: 'synced' },
  { name: '小红书', icon: platformIcon('xiaohongshu.svg'), url: 'https://www.xiaohongshu.com', syncStatus: 'synced' },
  { name: '微信读书', icon: platformIcon('weread.svg'), url: 'https://weread.qq.com', syncStatus: 'synced' },
  { name: '掘金', icon: platformIcon('juejin.svg'), url: 'https://juejin.cn', syncStatus: 'synced' },
  { name: 'CSDN', icon: platformIcon('csdn.svg'), url: 'https://www.csdn.net', syncStatus: 'synced' },
  { name: '网易云音乐', icon: platformIcon('netease-music.svg'), url: 'https://music.163.com', syncStatus: 'synced' },
  { name: 'QQ音乐', icon: platformIcon('qq-music.png'), url: 'https://y.qq.com', syncStatus: 'synced' },
  ...
  { name: 'Amazon', icon: platformIcon('amazon.svg'), url: 'https://www.amazon.com', syncStatus: 'synced' },
  ...
  { name: 'Slack', icon: platformIcon('slack.svg'), url: 'https://slack.com', syncStatus: 'synced' },
  ...
  { name: 'Outlook', icon: platformIcon('outlook.svg'), url: 'https://outlook.live.com', syncStatus: 'synced' },
  { name: 'Microsoft', icon: platformIcon('microsoft.svg'), url: 'https://www.microsoft.com', syncStatus: 'synced' },
  ...
  { name: 'Product Hunt', icon: platformIcon('producthunt.svg'), url: 'https://www.producthunt.com', syncStatus: 'synced' },
  ...
  { name: 'LinkedIn', icon: platformIcon('linkedin.svg'), url: 'https://www.linkedin.com', syncStatus: 'synced' },
...
const builtinCategoryApps: Omit<Apps, 'id' | 'order'>[] = [
  ...
  { name: 'DeepSeek', icon: platformIcon('deepseek.svg'), url: 'https://chat.deepseek.com', categoryId: 'ai', syncStatus: 'synced' },
  ...
  { name: 'Perplexity', icon: platformIcon('perplexity.svg'), url: 'https://www.perplexity.ai', categoryId: 'ai', syncStatus: 'synced' },
  { name: 'Poe', icon: platformIcon('poe.svg'), url: 'https://poe.com', categoryId: 'ai', syncStatus: 'synced' },

  { name: 'Figma', icon: platformIcon('figma.svg'), url: 'https://www.figma.com', categoryId: 'design', syncStatus: 'synced' },
  { name: 'Canva', icon: platformIcon('canva.svg'), url: 'https://www.canva.com', categoryId: 'design', syncStatus: 'synced' },
  ...
  { name: '站酷', icon: platformIcon('zcool.svg'), url: 'https://www.zcool.com.cn', categoryId: 'design', syncStatus: 'synced' },
  ...
  { name: 'Unsplash', icon: platformIcon('unsplash.svg'), url: 'https://unsplash.com', categoryId: 'design', syncStatus: 'synced' },
  ...
  { name: '掘金', icon: platformIcon('juejin.svg'), url: 'https://juejin.cn', categoryId: 'dev', syncStatus: 'synced' },
  { name: 'CSDN', icon: platformIcon('csdn.svg'), url: 'https://www.csdn.net', categoryId: 'dev', syncStatus: 'synced' },
  ...
  { name: '淘宝', icon: platformIcon('taobao.svg'), url: 'https://www.taobao.com', categoryId: 'shop', syncStatus: 'synced' },
  { name: '京东', icon: platformIcon('jd.png'), url: 'https://www.jd.com', categoryId: 'shop', syncStatus: 'synced' },
  ...
  { name: 'Amazon', icon: platformIcon('amazon.svg'), url: 'https://www.amazon.com', categoryId: 'shop', syncStatus: 'synced' },
  { name: 'eBay', icon: platformIcon('ebay.svg'), url: 'https://www.ebay.com', categoryId: 'shop', syncStatus: 'synced' },
  ...
  { name: '唯品会', icon: platformIcon('vip.svg'), url: 'https://www.vip.com', categoryId: 'shop', syncStatus: 'synced' },
  { name: '得物', icon: platformIcon('dewu.svg'), url: 'https://www.dewu.com', categoryId: 'shop', syncStatus: 'synced' }
]
...
const mergeDefaultApps = (storedApps: AppItem[]): AppItem[] => {
  const defaultAppMap = new Map(defaultApps.map((app) => [getDefaultAppKey(app), app]))
  const upgradedStoredApps = storedApps.map((app) => {
    const defaultApp = defaultAppMap.get(getDefaultAppKey(app))
    if (!defaultApp) return app
    return {
      ...app,
      icon: defaultApp.icon,
      iconBg: defaultApp.iconBg,
      syncStatus: 'pending' as const
    }
  })
  const existedKeys = new Set(upgradedStoredApps.map(getDefaultAppKey))
  const nextOrder = upgradedStoredApps.length ? Math.max(...upgradedStoredApps.map((app) => app.order || 0)) + 1 : 0
  const missingDefaults = createDefaultAppItems(nextOrder).filter((app) => !existedKeys.has(getDefaultAppKey(app)))

  if (!missingDefaults.length) return upgradedStoredApps
  return [...upgradedStoredApps, ...missingDefaults]
}
